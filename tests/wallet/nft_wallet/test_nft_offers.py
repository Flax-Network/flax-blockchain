...
async def test_nft_offer_with_fee(two_wallet_nodes: Any, trusted: Any) -> None:
    ...
    await time_out_assert(15, wallet_maker.get_confirmed_balance, maker_balance_pre + xfx_request - maker_fee)
    await time_out_assert(15, wallet_taker.get_confirmed_balance, taker_balance_pre - xfx_request - taker_fee)
    ...
    await time_out_assert(15, get_trade_and_status, TradeStatus.CONFIRMED, trade_manager_maker, trade_make)
    await time_out_assert(15, get_trade_and_status, TradeStatus.CONFIRMED, trade_manager_taker, trade_take)
    await time_out_assert(15, wallet_maker.get_confirmed_balance, maker_balance_pre - xfx_offered - maker_fee)
    await time_out_assert(15, wallet_taker.get_confirmed_balance, taker_balance_pre + xfx_offered - taker_fee)
