...
@click.option(
    "-m",
    "--fee",
    help="Set the fees per transaction, in XFX. Fee is used TWICE: once to create the singleton, once for init.",
    type=str,
    default="0",
    show_default=True,
    required=True,
...
@click.option(
    "-m",
    "--fee",
    help="Set the fees per transaction, in XFX. Fee is used TWICE: once to leave pool, once to join.",
    type=str,
    default="0",
    show_default=True,
    required=True,
...
@click.option(
    "-m",
    "--fee",
    help="Set the fees per transaction, in XFX. Fee is charged TWICE.",
    type=str,
    default="0",
    show_default=True,
    required=True,
