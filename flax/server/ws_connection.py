...
from flax.protocols.protocol_timing import API_EXCEPTION_BAN_SECONDS, INTERNAL_PROTOCOL_ERROR_BAN_SECONDS
from flax.protocols.shared_protocol import Capability, Handshake
from flax.server.capabilities import known_active_capabilities
...
ConnectionCallback = Callable[["WSFlaxConnection"], Awaitable[None]]
