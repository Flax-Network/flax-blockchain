...
from flax.daemon.server import pid_path_for_service
...
def launch_service(root_path: Path, service_command) -> Tuple[subprocess.Popen, Path]:
    ...
    print(f"Launching service with FLAX_ROOT: {os.environ['FLAX_ROOT']}")
...
if getattr(sys, "frozen", False):
    name_map = {
        "flax_seeder": "flax_seeder",
        "flax_seeder_crawler": "flax_seeder_crawler",
        "flax_seeder_server": "flax_seeder_server",
    }
