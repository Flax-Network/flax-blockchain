...
from flax.protocols.wallet_protocol import PuzzleSolutionResponse, CoinState
...
from flax.wallet.puzzles.genesis_checkers import ALL_LIMITATIONS_PROGRAMS
...
from flax.wallet.util.wallet_types import WalletType, AmountWithPuzzlehash
                ...
                if need_flax_transaction:
                    if fee > regular_flax_to_claim:
                        ...
                        flax_tx, _ = await self.create_tandem_xfx_tx(
                            fee, uint64(regular_flax_to_claim), announcement_to_assert=announcement
                        )
                        ...
                        flax_tx, _ = await self.create_tandem_xfx_tx(fee, uint64(regular_flax_to_claim))
                        innersol = self.standard_wallet.make_solution(
