...
from flax.wallet.util.wallet_sync_utils import PeerRequestException, last_change_height_cs
...
class WalletStateManager:
    ...
    async def get_minter_did(self, launcher_coin: Coin, peer: WSFlaxConnection) -> Optional[bytes32]:
        # Get minter DID
