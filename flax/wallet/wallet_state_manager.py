...
from flax.protocols.wallet_protocol import PuzzleSolutionResponse, RespondPuzzleSolution, CoinState
...
from flax.util.ints import uint32, uint64, uint128, uint8
from flax.util.db_synchronous import db_synchronous_on
from flax.wallet.cat_wallet.cat_utils import match_cat_puzzle, construct_cat_puzzle
...
class WalletStateManager:
    ...
    async def new_coin_state(
        self, coin_states: List[CoinState], peer: WSFlaxConnection, fork_height: Optional[uint32]
    ) -> None:
