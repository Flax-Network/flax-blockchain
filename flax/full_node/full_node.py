...
class FullNode:
    ...
    async def sync_from_fork_point(
        ...
        async def fetch_block_batches(batch_queue: asyncio.Queue, peers_with_peak: List[ws.WSFlaxConnection]):
            try:
        ...
        batch_queue: asyncio.Queue[Tuple[ws.WSFlaxConnection, List[FullBlock]]] = asyncio.Queue(maxsize=buffer_size)
