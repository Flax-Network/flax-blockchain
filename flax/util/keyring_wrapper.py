...
class KeyringWrapper:
    ...
    def _configure_backend(self) -> Union[Any, FileKeyring]:
        from flax.util.keychain import supports_keyring_passphrase
    ...
    def set_master_passphrase(
        ...
        from flax.util.keychain import KeyringCurrentPassphaseIsInvalid, KeyringRequiresMigration
    ...
    def migrate_legacy_keyring(self):
        ...
        from flax.util.keychain import Keychain, MAX_KEYS
    ...
    def confirm_legacy_keyring_cleanup(self, legacy_keyring, service, users):
        ...
        # [flax_2Duser_2Dflax_2D1_2E8] is left behind
