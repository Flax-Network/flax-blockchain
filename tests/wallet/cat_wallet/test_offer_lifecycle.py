...
class TestOfferLifecycle:
    ...
    async def test_complex_offer(self, setup_sim):
        ...
        try:
            ...
            flax_announcements: List[Announcement] = Offer.calculate_announcements(flax_requested_payments)
            flax_secured_bundle: SpendBundle = self.generate_secure_bundle(flax_coins, flax_announcements, 1000)
            flax_offer = Offer(flax_requested_payments, flax_secured_bundle)
            ...
            new_offer = Offer.aggregate([flax_offer, red_offer])
