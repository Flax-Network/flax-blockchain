...
@click.option("--testnet", is_flag=True, help="Configure this flax install to connect to the testnet")
...
def init_cmd(ctx: click.Context, create_certs: str, fix_ssl_permissions: bool, testnet: bool, v1_db: bool, **kwargs):
    ...
    from flax.cmds.passphrase_funcs import initialize_passphrase
