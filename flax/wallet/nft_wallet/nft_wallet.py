...
from flax.wallet.trading.offer import OFFER_MOD, NotarizedPayment, Offer
...
class NFTWallet:
    ...
    async def make_nft1_offer(
        ...
        if offering_nft:  # if we are offering an NFT.
            ...
            if requested_asset_id is None:  # If we are just asking for xfx.
            ...
            if offered_asset_id is None:  # xfx offer
