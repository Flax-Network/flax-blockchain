...
Write-Output "Remove unused @flax-network packages to make cache slim"
...
# Remove `packages/gui/node_modules/@flax-network` because it causes an error on later `electron-packager` command
Remove-Item "@flax-network" -Recurse -Force
