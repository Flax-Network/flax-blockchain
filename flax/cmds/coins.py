...
@click.option(
    "--max-amount",
    help="Ignore coins worth more then this much XFX or CAT units",
    type=str,
    default="0",
)
@click.option(
...
@click.option(
    ...
    "amounts_to_exclude",
    multiple=True,
    help="Exclude any coins with this XFX or CAT amount from being included.",
)
@click.option(
...
@click.option(
    "-a",
    "--target-amount",
    help="Select coins until this amount (in XFX or CAT) is reached. \
...
@click.option(
    "-a",
    "--amount-per-coin",
    help="The amount of each newly created coin, in XFX",
    type=str,
    required=True,
)
