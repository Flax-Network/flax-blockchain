...
required to run a [Timelord](https://github.com/Flax-Network/flax-blockchain/wiki/Timelords).
...
[install-timelord.sh](https://github.com/Flax-Network/flax-blockchain/blob/main/install-timelord.sh)
